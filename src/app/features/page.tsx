...
const modules = [
  ...
  },
  {
    ...
    icon: "camera",
    description:
      "Workers snap a photo of their CSCS card, OSHA cert, or right-to-work document. AI reads the card type, colour, expiry date, and cardholder name -- flagging issues instantly. Low-confidence results go to a manual review queue so nothing slips through the cracks.",
    capabilities: [
      ...
      "OSHA 10/30-Hour card verification (US market)",
  ...
  },
  {
    ...
    icon: "shield",
    description:
      "Never send a non-compliant worker to site. Pangaea tracks every document expiry, sends automatic reminders via WhatsApp, and blocks workers from allocation when they fall out of compliance. Your compliance dashboard gives you a single view of risk across your entire workforce.",
    capabilities: [
...
const onboardingMessages = [
  {
    ...
    text: "Hi! I'm Amber, your onboarding assistant at Pangaea. Let's get you set up -- it only takes a few minutes. What's your full name?",
    time: "09:01",
  },
  {
...
const complianceMessages = [
  {
    type: "incoming" as const,
    text: "Hi Darren, this is an automated reminder from Pangaea. Your CSCS Blue Skilled Worker card expires in 30 days (19 April 2026).",
    time: "08:00",
  },
  {
    type: "incoming" as const,
  ...
  {
    type: "incoming" as const,
    text: "Good to hear! We'll check back in 14 days. Once you receive the new card, just snap a photo and send it here -- we'll verify it automatically.",
    time: "08:45",
  },
  {
    type: "incoming" as const,
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="space-y-8">
                ...
                {showComplianceChat && (
                  <div className="flex justify-center">
                    <WhatsAppChat
                      contactName="Pangaea Compliance"
