...
export const metadata: Metadata = {
  title: "Platform",
  description:
    "See the Pangaea platform in action. Dashboard, workforce management, compliance tracking, AI assistant, timesheets, and more — screenshots of every module.",
};
...
const modules = [
  ...
  },
  {
    ...
    description:
      "The operatives page is the heart of Pangaea. Every worker in your system — from first-time applicant to active site worker — lives here. Filter by status, trade, compliance score, or data completeness. Toggle between table, card, and compact views. Sort by RAP score, last worked date, or charge rate. Bulk select for group actions. The search bar finds workers by name, phone, reference number, or NI number instantly.",
    capabilities: [
                    ...
                    <div className="bg-forest-800 px-4 py-2.5 flex items-center gap-2 border-b border-forest-700/50">
                      ...
                      <div className="flex-1 ml-3">
                        <div className="bg-forest-900/50 rounded-md px-3 py-1 max-w-xs">
                          <span className="text-[0.6rem] text-white/30 font-mono">pangaea.app/{m.title.toLowerCase().replace(/\s+/g, '-')}</span>
                        </div>
                      </div>
                    </div>
